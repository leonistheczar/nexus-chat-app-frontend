...
export default function NotFound() {
  return (
    <div className="h-dvh flex flex-col items-center justify-center p-12 text-text-900 w-full text-center rounded-2xl bg-background-50 shadow-lg overflow-hidden">
        {/* 404 Code */}
